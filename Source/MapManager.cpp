...
MapManager::MapManager() :
	coin_animation(CELL_SIZE, "../Source/Resources/Images/Coin.png", COIN_ANIMATION_SPEED),
	question_block_animation(CELL_SIZE, "../Source/Resources/Images/QuestionBlock.png", QUESTION_BLOCK_ANIMATION_SPEED)
{
	map_texture.loadFromFile("../Source/Resources/Images/Map.png");
...
{
	map_sketch.loadFromFile("../Source/Resources/Images/LevelSketch" + std::to_string(static_cast<unsigned short>(i_current_level)) + ".png");
}
