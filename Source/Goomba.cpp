...
Goomba::Goomba(const bool i_underground, const float i_x, const float i_y) :
	...
	walk_animation(CELL_SIZE, "../Source/Resources/Images/GoombaWalk.png", GOOMBA_WALK_ANIMATION_SPEED)
{
	horizontal_speed = -GOOMBA_SPEED;

	if (0 == underground)
	{
		texture.loadFromFile("../Source/Resources/Images/GoombaDeath0.png");
	}
	else
	{
		texture.loadFromFile("../Source/Resources/Images/UndergroundGoombaDeath0.png");

		walk_animation.set_texture_location("../Source/Resources/Images/UndergroundGoombaWalk.png");
	}
}
	...
	switch (i_death_type)
	{
		...
		case 2:
		{
			if (GOOMBA_DEATH_DURATION == death_timer)
			{
				...
				if (0 == underground)
				{
					texture.loadFromFile("../Source/Resources/Images/GoombaDeath1.png");
				}
				else
				{
					texture.loadFromFile("../Source/Resources/Images/UndergroundGoombaDeath1.png");
				}
			}
		}
	}
